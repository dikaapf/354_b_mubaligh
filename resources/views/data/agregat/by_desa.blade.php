    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <a href="<?= url('/files/jumlah_penduduk_tingkat_desa_kel.xlsx') ?>" class="btn btn-primary">Klik Untuk Download dalam format Excel</a>
                    <br />
...
//            alert($('#t_dkb').val());
            window.open("<?= url('agregat/by_desa/') ?>/" + $('#t_dkb').val() + "/xls", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=50,left=100,width=800,height=1000");
