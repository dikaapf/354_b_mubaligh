...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Data Agregat Penduduk Berdasarkan Jenis Kelamin<small>Tingkat Desa/Kelurahan/Kampung</small></h2>
...
//                    print_r(setDataInstansi());
                    ?>
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('agg.post_by_desa_jk') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <!--<button class="btn btn-success  _cetakXlsJk" type="button">Download excel</button>-->
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <a href="<?= url('/files/jumlah_penduduk_kampung_jk.xlsx') ?>" class="btn btn-primary">Klik Untuk Download dalam format Excel</a>
...
//            alert($('#t_dkb').val());
        ...
        $('body').delegate('._cetakXlsJk', 'click', function () {

//            alert($('#t_dkb').val());
            window.open("<?= url('agregat/by_desa_jk/') ?>/" + $('#t_dkb').val() + "/xls", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=50,left=100,width=800,height=1000");
