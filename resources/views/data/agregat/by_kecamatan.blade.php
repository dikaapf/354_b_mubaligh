...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Data Agregat Penduduk Berdasarkan Jenis Kelamin<small>Tingkat Kecamatan / Distrik</small></h2>
...
//                    print_r(setDataInstansi());
                    ?>
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('agg.post_by_kecamatan') }}">
                        {{ csrf_field() }}
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <a href="<?= url('/files/jumlah_penduduk_tingkat_kecamatan.xlsx') ?>" class="btn btn-primary">Klik Untuk Download dalam format Excel</a>
                    <br />
...
//            alert($('#t_dkb').val());
            window.open("<?= url('agregat/by_kecamatan/') ?>/" + $('#t_dkb').val() + "?download=pdf", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=50,left=100,width=800,height=1000");
...
//            alert($('#t_dkb').val());
            window.open("<?= url('agregat/by_kecamatan/') ?>/" + $('#t_dkb').val() + "/xls", "_blank", "toolbar=no,scrollbars=yes,resizable=no,top=50,left=100,width=800,height=1000");
