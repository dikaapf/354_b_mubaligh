...
@section('title')
Rekapitulasi Penerbitan Kartu Keluarga
@stop
@section('content')
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Rekapitulasi Penerbitan Kartu Keluarga<small>Data Pelayanan SIAK</small></h2>
                    ...
                    <form data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('capil.rekap_lahir') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::select('tahun',listTahunKk(),null,['required'=>'','id'=>'tahun','class'=>'form-control']) !!}
