                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Beranda <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-users"></i><span class="hide-menu">Manajemen Pengguna</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?= url('/userlist') ?>">Data Pengguna</a></li>
                                    <li><a href="<?= url('/user/add') ?>">Tambah Pengguna</a></li>
