                                                            ...
                                                            <table id="idTabelFormulir" class="table card-table table-vcenter">
                                                                ...
                                                                <tbody>
                                                                    <tr id='formulir0' data-id="0">
                                                                        ...
                                                                        <td>
                                                                            <textarea name="deskripsi_formulir[]" class="form-control" placeholder="Deskripsi formulir" rows="1" maxlength="255">-</textarea>
                                                                        </td>		
                                                                        <td>
                                                            ...
                                                            <table id="idTabelIsian" class="table card-table table-vcenter">
                                                                ...
                                                                <tbody>
                                                                    <tr id='isian0' data-id="0">
                                                                        ...
                                                                        <td>
                                                                            <textarea name="ket_form[]" class="form-control" placeholder="Deskripsi isian" rows="1" maxlength="255">-</textarea>
                                                                        </td>					
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <button type="button" name="del0" class="btn btn-sm block btn-danger row-remove" data-toggle="tooltip" data-placement="top" title="Hapus Field"><i class="fa fa-times-rectangle"></i></button>
                                                            ...
                                                            <table id="idTabelProses" class="table card-table table-vcenter">
                                                                ...
                                                                <tbody>
                                                                    <tr id='isian0' data-id="0">
                                                                        ...
                                                                        <td>
                                                                            <textarea name="deskripsi_proses[]" class="form-control" placeholder="Deskripsi proses" rows="1" maxlength="255">-</textarea>
                                                                        </td>					
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <button type="button" name="del0" class="btn btn-sm block btn-danger row-remove" data-toggle="tooltip" data-placement="top" title="Hapus Field"><i class="fa fa-times-rectangle"></i></button>
                                                            ...
                                                            <table id="idTabelDownload" class="table card-table table-vcenter">
                                                                ...
                                                                <tbody>
                                                                    <tr id='isian0' data-id="0">
                                                                        ...
                                                                        <td>
                                                                            <textarea name="dokumen_deskripsi[]" class="form-control" placeholder="Deskripsi isian" rows="1" maxlength="255">-</textarea>
                                                                        </td>					
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <button type="button" name="del0" class="btn btn-sm block btn-danger row-remove" data-toggle="tooltip" data-placement="top" title="Hapus Field"><i class="fa fa-times-rectangle"></i></button>
