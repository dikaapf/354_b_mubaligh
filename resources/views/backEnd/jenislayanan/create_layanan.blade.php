                        ...
                        <div class="col-md-6">
                            <div class="card border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Petunjuk lengkap tentang pengajuan layanan Layanan Kartu Keluarga dapat didownload dengan menekan tombol berikut:</p>
                                    <a href="javascript:void(0)" class="btn btn-primary"><i class="fa fa-download"></i>  &nbsp;Download Petunjuk</a>
                                    <hr>
                                    <div>
                                        <h5 class="card-title">Dokumen Fisik Persyaratan</h5>
                                    </div>

                                    <input readonly="" type="checkbox" <?= $pelayanan->kirim_syarat == 1 ? 'checked' : '' ?>  class="js-switch" data-color="#cd0a0a" data-size="small"/> Pemohon harus mengirimkan dokumen fisik persyaratan ke Disdukcapil sebelum pengajuan dapat diproses lebih lanjut
