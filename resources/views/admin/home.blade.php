...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-uppercase">Pemasukan</h5>
                    <div class="text-right"> <span class="text-muted">Monthly Fees</span>
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-uppercase">Pengeluaran</h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title text-uppercase">Statistik<br><small class="text-muted">All Earnings are in million $</small></h5>
                        <div class="ml-auto">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card m-b-15">
                        <div class="card-body">
                            <h5 class="card-title text-uppercase">statistik</h5>
                            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card bg-info m-b-15">
                        <div class="card-body">
                            <h5 class="text-white card-title text-uppercase">statistik</h5>
                            <div class="row">
                                <div class="col-6 m-t-30">
...
<!--    <div class="row">
        <div class="col-md-3">
            <img class="img-responsive" alt="user" src="<?= asset('public/skin') ?>/dist/images/big/c2.jpg">
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <img class="img-responsive" alt="user" src="<?= asset('public/skin') ?>/dist/images/big/c1.jpg">
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <img class="img-responsive" alt="user" src="<?= asset('public/skin') ?>/dist/images/big/c4.jpg">
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-md-3">
            <img class="img-responsive" alt="user" src="<?= asset('public/skin') ?>/dist/images/big/c3.jpg">
            <div class="card">
                <div class="card-body">
